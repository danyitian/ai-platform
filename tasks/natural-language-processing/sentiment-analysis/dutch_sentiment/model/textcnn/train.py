...
tf.flags.DEFINE_string("data_file", "../../data/textcnn_train.txt", "Data source for the positive data.")
...
print("Loading data...")
x_text, y = data_helper.load_data(FLAGS.data_file)
